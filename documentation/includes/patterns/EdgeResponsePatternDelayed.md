...
### EdgeResponsePatternDelayed Globally
```
Globally, it is always the case that once "R" becomes satisfied, "Q" holds after at most "5" time units
```
...
| ![](../img/failure_paths/positive/EdgeResponsePatternDelayed_Globally_3.svg) |  |
