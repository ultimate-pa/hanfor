...
PATTERNS = {
    ...
    "TimeConstrainedMinDuration": {
        ...
        "env": {"R": ["bool"], "S": ["real", "int"], "T": ["bool"], "U": ["real", "int"]},
        "group": "Real-time",
        "pattern_order": 0,
    },
    ...
    "ConstrainedTimedExistence": {
        ...
        "env": {"R": ["bool"], "S": ["bool"], "T": ["real", "int"], "U": ["real", "int"]},
        "group": "Real-time",
        "pattern_order": 0,
    },
    ...
    "BndTriggeredEntryConditionPattern": {
        ...
        "env": {"R": ["bool"], "S": ["real", "int"], "T": ["bool"], "U": ["bool"]},
        "group": "Real-time",
        "pattern_order": 0,
    },
    ...
    "Toggle2": {
        ...
        "countertraces": {"GLOBALLY": [], "BEFORE": [], "AFTER": [], "BETWEEN": [], "AFTER_UNTIL": []},
        "env": {"R": ["bool"], "S": ["bool"], "T": ["bool"], "U": ["real", "int"]},
        "group": "Legacy",
        "pattern_order": 0,
    },
    # TODO: Legacy, not implemented
