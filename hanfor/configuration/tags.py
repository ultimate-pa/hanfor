...
STANDARD_TAGS = {
    ...
    "redundant": {"color": orange, "internal": False, "description": """The requirement is stated more than once."""},
    "imprecise": {
        "color": orange,
        "internal": False,
    ...
    "unclear": {"color": reddishpurple, "internal": False, "description": """Meaning of the requirement is unclear."""},
    "non-functional": {
        "color": bluishgreen,
        "internal": True,
        "description": """Meaning of this requirement is clear, but it has no functional behaviour (in the sense formalisability).""",
    },
    "post-poned": {
        "color": bluishgreen,
        "internal": True,
        "description": """Attemt at formalisation is post-poned untli more information on the system is available.""",
    },
