...
function bind_multiple_tags_added_events() {
    $('#multi-add-tag-input')
        .on('tokenfield:createtoken', function (e) {
            let multiple_tokens = $(this).tokenfield('getTokens');
            for (const token of multiple_tokens) {
...
// Initialize tag autocomplete field in the requirements modal.
    $('#requirement_tag_field')
        .tokenfield({
            autocomplete: {
                source: available_tags,
...
$(document).ready(function () {
    ...
    bind_multiple_tags_added_events();
});
