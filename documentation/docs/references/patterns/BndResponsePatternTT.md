...
```
```
Counterexample: true;⌈R⌉ ∧ ℓ ≥ 5;⌈Q⌉ ∧ ℓ < 10;⌈!Q⌉;true
```
...
| --- | --- |
| ![](../img/failure_paths/positive/BndResponsePatternTT_Globally_0.svg) |  |
| ![](../img/failure_paths/positive/BndResponsePatternTT_Globally_1.svg) |  |
