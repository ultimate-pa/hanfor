...
class TestVariableImport(TestCase):
    ...
    def test_import_from_csv(self):
        ...
        var_gets = self.app.get('api/var/gets')
        self.assertEqual(
            {'integer_constant', 'real_constant', 'boolean_variable', 'integer_variable', 'real_variable',
             'integer_enum', 'integer_enum_enumerator_0', 'real_enum', 'real_enum_enumerator_0'},
