    ...
    def get(self, command: str, name: str) -> str:
        if command == 'version':
            ...
            if name == 'post':
                ...
                return self.ultimate.get_job('node016osmxp6sstzvei3sxbfrcvdu41')
            else:
                return self.ultimate.delete_job('node016osmxp6sstzvei3sxbfrcvdu41')
