...
testcases = {
    ...
    'absence_between':
        Test({'P': Symbol('P'), 'Q': Symbol('Q'), 'R': Symbol('R')},
    ...
    'duration_bound_l_globally':
        Test({'R': Symbol('R'), 'T': Symbol('T', REAL)},
             'true;⌈!R⌉;⌈R⌉ ∧ ℓ < T;⌈!R⌉;true',
             'True;⌈(! R)⌉;⌈R⌉ ∧ ℓ < T;⌈(! R)⌉;True'),

    'duration_bound_l_before':
        Test({'P': Symbol('P'), 'R': Symbol('R'), 'T': Symbol('T', REAL)},
    ...
    'duration_bound_l_between':
        Test({'P': Symbol('P'), 'Q': Symbol('Q'), 'R': Symbol('R'), 'T': Symbol('T', REAL)},
    ...
    'response_delay_before':
        Test({'P': Symbol('P'), 'R': Symbol('R'), 'S': Symbol('S'), 'T': Symbol('T', REAL)},
    ...
    'response_delay_between':
        Test({'P': Symbol('P'), 'Q': Symbol('Q'), 'R': Symbol('R'), 'S': Symbol('S'), 'T': Symbol('T', REAL)},
