...
PATTERNS = {
    ...
    'ExistenceBoundU': {
        ...
        'countertrace': {
            ...
            'between': [
                'rue;⌈(P && !Q)⌉;⌈!Q⌉;⌈(!Q && R)⌉;⌈(!Q && !R)⌉;⌈(!Q && R)⌉;⌈(!Q && !R)⌉;⌈(!Q && R)⌉;⌈!Q⌉;⌈Q⌉;true'],
    ...
    'PrecedenceChain2-1': {
        ...
        'countertrace': {
            ...
            'before': ['⌈(!P && !T)⌉;⌈(!P && R)⌉;true', '⌈(!P && !S)⌉;⌈(!P && R)⌉;true',
                       '⌈(!P && !T)⌉;⌈(!P && (S && !T))⌉;⌈(!P && !T)⌉;⌈(!P && (!S && T))⌉;⌈(!P && !S)⌉;⌈(!P && R)⌉;true'],
            'after': ['true;⌈P⌉;⌈!T⌉;⌈R⌉;true', 'true;⌈P⌉;⌈!S⌉;⌈R⌉;true',
            ...
            'after until': ['true;⌈P⌉;⌈(!Q && !T)⌉;⌈(!Q && R)⌉;true', 'true;⌈P⌉;⌈(!Q && !S)⌉;⌈(!Q && R)⌉;true',
